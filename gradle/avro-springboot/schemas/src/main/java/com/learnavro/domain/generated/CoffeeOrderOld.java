...
static {
   ...
   */
  public CoffeeOrderOld(java.lang.Long id, java.lang.String name, com.learnavro.domain.generated.Store store, java.util.List<com.learnavro.domain.generated.OrderLineItem> orderLineItems) {
    this.id = id;
    this.name = name;
    this.store = store;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeOrderOld>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learnavro.domain.generated.CoffeeOrderOld.Builder setName(java.lang.String value) {
